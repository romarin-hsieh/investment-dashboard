Feature: One visual grammar across routes
  ...
  @bound(src/bdd/ui-consistency.feature.test.ts) @pending-fix(fix/ui-consistency · SC-1)
  ...
  @bound(src/bdd/ui-consistency.feature.test.ts) @pending-fix(fix/ui-consistency · SC-6)
